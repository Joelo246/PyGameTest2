...
DefBackground = pygame.image.load('DefBackground.jpg')
BackRect = DefBackground.get_rect()
BackStart = 200
bbx, bby = (24, BackStart)
BackRect.topleft = (bbx, bby)
...
while True:
    ...
    if brickHitIndex >= 0:
        ...
        if mx > hb.x + hb.width or mx < hb.x:
            sx *= -1
            mainSurface.blit(DefBackground, BackRect)
        else:
            sy *= -1
